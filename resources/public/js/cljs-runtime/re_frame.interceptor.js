...
var len__5769__auto___38748 = arguments.length;
var i__5770__auto___38749 = (0);
while(true){
if((i__5770__auto___38749 < len__5769__auto___38748)){
args__5775__auto__.push((arguments[i__5770__auto___38749]));

var G__38750 = (i__5770__auto___38749 + (1));
i__5770__auto___38749 = G__38750;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__38677){
var map__38678 = p__38677;
var map__38678__$1 = cljs.core.__destructure_map(map__38678);
var m = map__38678__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38678__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38678__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38678__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38678__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___38751 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___38751){
var unknown_keys_38752 = temp__5802__auto___38751;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_38752], 0));
} else {
}
} else {
}

var G__38685 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5045__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38685,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__38685;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq38670){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq38670));
}));
...
var G__38758 = (i__5770__auto___38755 + (1));
i__5770__auto___38755 = G__38758;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq38690){
...
var G__38693 = cljs.core.first(seq38690__$2);
var seq38690__$3 = cljs.core.next(seq38690__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38691,G__38692,G__38693,seq38690__$3);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___38760 = arguments.length;
var i__5770__auto___38761 = (0);
while(true){
if((i__5770__auto___38761 < len__5769__auto___38760)){
args__5775__auto__.push((arguments[i__5770__auto___38761]));

var G__38762 = (i__5770__auto___38761 + (1));
i__5770__auto___38761 = G__38762;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq38702){
...
var G__38705 = cljs.core.first(seq38702__$2);
var seq38702__$3 = cljs.core.next(seq38702__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38703,G__38704,G__38705,seq38702__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__38711,interceptor,direction){
var map__38715 = p__38711;
var map__38715__$1 = cljs.core.__destructure_map(map__38715);
var context = map__38715__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38715__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
var args__5775__auto__ = [];
var len__5769__auto___38770 = arguments.length;
var i__5770__auto___38771 = (0);
while(true){
if((i__5770__auto___38771 < len__5769__auto___38770)){
args__5775__auto__.push((arguments[i__5770__auto___38771]));

var G__38772 = (i__5770__auto___38771 + (1));
i__5770__auto___38771 = G__38772;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq38733){
var G__38734 = cljs.core.first(seq38733);
var seq38733__$1 = cljs.core.next(seq38733);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38734,seq38733__$1);
}));
...
var map__38740 = cljs.core.ex_data(re_frame_error);
var map__38740__$1 = cljs.core.__destructure_map(map__38740);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38740__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38740__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38740__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
var event_handler_QMARK_ = (function (){var fexpr__38741 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097),null,new cljs.core.Keyword(null,"db-handler","db-handler",579530098),null,new cljs.core.Keyword(null,"ctx-handler","ctx-handler",-1777672230),null], null), null);
return (fexpr__38741.cljs$core$IFn$_invoke$arity$1 ? fexpr__38741.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__38741.call(null,interceptor));
})();
...
}catch (e38745){var e = e38745;
var G__38746 = cljs.core.ex_cause(e);
var G__38747 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__38746,G__38747) : error_handler.call(null,G__38746,G__38747));
}}
});
