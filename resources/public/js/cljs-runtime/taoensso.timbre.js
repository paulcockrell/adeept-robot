...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq46632){
var G__46633 = cljs.core.first(seq46632);
var seq46632__$1 = cljs.core.next(seq46632);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46633,seq46632__$1);
}));
...
var err_46745 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_46746 = (function (p1__46634_SHARP_){
var G__46635 = p1__46634_SHARP_;
var G__46635__$1 = (((G__46635 instanceof cljs.core.Keyword))?G__46635.fqn:null);
switch (G__46635__$1) {
case "trace":
return (0);
...
if(cljs.core.truth_(level__GT_int_46746(x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(err_46745,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type(x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5045__auto__ = level__GT_int_46746(x);
...
var valid_level__GT_int_46748 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return ((valid_level__GT_int_46748.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_46748.cljs$core$IFn$_invoke$arity$1(x) : valid_level__GT_int_46748.call(null,x)) >= (valid_level__GT_int_46748.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_46748.cljs$core$IFn$_invoke$arity$1(y) : valid_level__GT_int_46748.call(null,y)));
});
var fn_QMARK__46749 = cljs.core.fn_QMARK_;
var compile_46750 = taoensso.encore.fmemoize((function (x){
return taoensso.encore.name_filter(x);
}));
var conform_QMARK__STAR__46751 = taoensso.encore.fmemoize((function (x,ns){
var fexpr__46636 = compile_46750(x);
return (fexpr__46636.cljs$core$IFn$_invoke$arity$1 ? fexpr__46636.cljs$core$IFn$_invoke$arity$1(ns) : fexpr__46636.call(null,ns));
}));
var conform_QMARK__46752 = (function (ns_filter,ns){
if(cljs.core.truth_((fn_QMARK__46749.cljs$core$IFn$_invoke$arity$1 ? fn_QMARK__46749.cljs$core$IFn$_invoke$arity$1(ns_filter) : fn_QMARK__46749.call(null,ns_filter)))){
return (ns_filter.cljs$core$IFn$_invoke$arity$1 ? ns_filter.cljs$core$IFn$_invoke$arity$1(ns) : ns_filter.call(null,ns));
} else {
return conform_QMARK__STAR__46751(ns_filter,ns);
}
});
taoensso.timbre.may_log_ns_QMARK_ = (function taoensso$timbre$may_log_ns_QMARK_(ns_filter,ns){
if(cljs.core.truth_(conform_QMARK__46752(ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome.cljs$core$IFn$_invoke$arity$2((function (p__46637){
var vec__46638 = p__46637;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46638,(0),null);
var min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46638,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__46751(ns_pattern,ns))){
...
var valid_level_46753 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_46754 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
var G__46641 = (function (){var or__5045__auto__ = ((cljs.core.vector_QMARK_(x))?ns__GT__QMARK_min_level_46754(x,ns):x);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return default$;
...
return (valid_level_46753.cljs$core$IFn$_invoke$arity$1 ? valid_level_46753.cljs$core$IFn$_invoke$arity$1(G__46641) : valid_level_46753.call(null,G__46641));
});
var leglist_46755 = (function (x){
if(cljs.core.truth_(x)){
if(cljs.core.truth_((function (){var fexpr__46642 = cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY,cljs.core.PersistentHashSet.EMPTY]);
return (fexpr__46642.cljs$core$IFn$_invoke$arity$1 ? fexpr__46642.cljs$core$IFn$_invoke$arity$1(x) : fexpr__46642.call(null,x));
})())){
return null;
} else {
return x;
...
var ns_whitelist__$1 = leglist_46755(ns_whitelist);
var ns_blacklist__$1 = leglist_46755(ns_blacklist);
...
var level_GT__EQ__46756 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__46757 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_46758 = taoensso.timbre.get_min_level;
var legacy_ns_filter_46759 = taoensso.timbre.legacy_ns_filter;
/**
...
var min_level = (function (){var G__46645 = default_min_level;
var G__46646 = (function (){var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var G__46647 = _QMARK_ns_str;
return (get_min_level_46758.cljs$core$IFn$_invoke$arity$3 ? get_min_level_46758.cljs$core$IFn$_invoke$arity$3(G__46645,G__46646,G__46647) : get_min_level_46758.call(null,G__46645,G__46646,G__46647));
})();
if(cljs.core.truth_((level_GT__EQ__46756.cljs$core$IFn$_invoke$arity$2 ? level_GT__EQ__46756.cljs$core$IFn$_invoke$arity$2(level,min_level) : level_GT__EQ__46756.call(null,level,min_level)))){
...
var G__46648 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774));
var G__46649 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142));
return (legacy_ns_filter_46759.cljs$core$IFn$_invoke$arity$2 ? legacy_ns_filter_46759.cljs$core$IFn$_invoke$arity$2(G__46648,G__46649) : legacy_ns_filter_46759.call(null,G__46648,G__46649));
}
})();
if(cljs.core.truth_(temp__5802__auto__)){
var ns_filter = temp__5802__auto__;
if(cljs.core.truth_((may_log_ns_QMARK__46757.cljs$core$IFn$_invoke$arity$2 ? may_log_ns_QMARK__46757.cljs$core$IFn$_invoke$arity$2(ns_filter,_QMARK_ns_str) : may_log_ns_QMARK__46757.call(null,ns_filter,_QMARK_ns_str)))){
return true;
} else {
return false;
}
...
var min_level_STAR___$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__46650){
var vec__46651 = p__46650;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46651,(0),null);
var _pattern_min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46651,(1),null);
var entry = vec__46651;
...
var min_level_STAR___$2 = (function (){var temp__5802__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(min_level_STAR___$1),(1)))?(function (){var vec__46654 = min_level_STAR___$1;
var vec__46657 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46654,(0),null);
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46657,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46657,(1),null);
...
var map__46661 = timestamp_opts;
var map__46661__$1 = cljs.core.__destructure_map(map__46661);
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46661__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var vec__46665 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46665,(0),null);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__46668 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46668,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = ((fmt_msg_QMARK_)?(function (){var vec__46671 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46671,(0),null);
return v0__$1;
})():null);
var vargs__$2 = ((fmt_msg_QMARK_)?taoensso.encore.vrest(vargs__$1):vargs__$1);
...
}catch (e46674){var t = e46674;
var map__46675 = data;
var map__46675__$1 = cljs.core.__destructure_map(map__46675);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46675__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46675__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46675__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46675__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
if(cljs.core.truth_((function (){var or__5045__auto__ = may_log;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var instant_46770__$1 = (function (){var or__5045__auto__ = instant;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return (new Date());
...
var context_46771 = taoensso.timbre._STAR_context_STAR_;
var vargs_46772 = cljs.core.deref(vargs_);
var vec__46678_46773 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_46772);
var _QMARK_err_46774__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46678_46773,(0),null);
var _QMARK_meta_46775 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46678_46773,(1),null);
var _QMARK_msg_fmt_46776 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46678_46773,(2),null);
var vargs_46777__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46678_46773,(3),null);
var data_46778 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891),new cljs.core.Keyword(null,"?column","?column",1004649085)],[instant_46770__$1,spying_QMARK_,config,vargs_46777__$1,_QMARK_file,cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null),level),_QMARK_ns_str,level,msg_type,_QMARK_err_46774__$1,context_46771,_QMARK_line,_QMARK_meta_46775,_QMARK_msg_fmt_46776,_QMARK_column]));
var _QMARK_data_46779 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_46778,cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"middleware","middleware",1462115504)));
var temp__5804__auto___46788 = _QMARK_data_46779;
if(cljs.core.truth_(temp__5804__auto___46788)){
var data_46789__$1 = temp__5804__auto___46788;
var map__46681_46791 = data_46789__$1;
var map__46681_46792__$1 = cljs.core.__destructure_map(map__46681_46791);
var vargs_46793__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46681_46792__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_46794__$2 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_46789__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
return taoensso.timbre.protected_fn("Timbre error when calling (msg-fn <data>)",taoensso.timbre.default_output_msg_fn)(data_46789__$1);
...
return cljs.core.hash((function (){var b2__39983__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_46775,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(b2__39983__auto__)){
var id = b2__39983__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,callsite_id,level], null);
} else {
var b2__39983__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_46775,new cljs.core.Keyword(null,"id!","id!",218090956));
if(cljs.core.truth_(b2__39983__auto____$1)){
var id = b2__39983__auto____$1;
return id;
} else {
var b2__39983__auto____$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(_QMARK_meta_46775,new cljs.core.Keyword(null,"hash","hash",-13781596));
if(cljs.core.truth_(b2__39983__auto____$2)){
var h = b2__39983__auto____$2;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,callsite_id,_QMARK_msg_fmt_46776,level], null);
} else {
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [vargs_46793__$2,callsite_id,_QMARK_msg_fmt_46776,level], null);
}
}
}
})());
}),null))], 0));
var get_timestamp_delay_46795 = (function (){var get_shared_delay = taoensso.encore.fmemoize((function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp(opts,cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_46794__$2,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
var get_output_fn_46796 = (function (){var base_fn = taoensso.encore.fmemoize(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
var base_output_opts_46797 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
return cljs.core.not((function (){var G__46682 = cljs.core.force(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_46794__$2,new cljs.core.Keyword(null,"hash_","hash_",-827203612)));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__46682) : rl_fn.call(null,G__46682));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__46683 = appender;
var map__46683__$1 = cljs.core.__destructure_map(map__46683);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46683__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46683__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
var timestamp_ = get_timestamp_delay_46795(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var output_fn = get_output_fn_46796(cljs.core.get.cljs$core$IFn$_invoke$arity$2(appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539)));
...
return base_output_opts_46797;
}
})();
var output_ = (new cljs.core.Delay((function (){
var G__46684 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data_46794__$2,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts], 0));
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(G__46684) : output_fn.call(null,G__46684));
}),null));
var data__$3 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_46794__$2,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325),output_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_], null));
...
}catch (e46690){var _pr_str_error = e46690;
try{return cljs.core.str.cljs$core$IFn$_invoke$arity$1(error);
}catch (e46691){var _str_error = e46691;
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46694__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
...
})(),clojure.string.upper_case(cljs.core.name(level))," ",(function (){var temp__5804__auto__ = (function (){var or__5045__auto__ = _QMARK_ns_str;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return _QMARK_file;
...
}catch (e46696){var ef_error = e46696;
 ...
 */
taoensso.timbre.default_output_msg_fn = (function taoensso$timbre$default_output_msg_fn(p__46699){
var map__46700 = p__46699;
var map__46700__$1 = cljs.core.__destructure_map(map__46700);
var data = map__46700__$1;
var msg_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46700__$1,new cljs.core.Keyword(null,"msg-type","msg-type",-2132567822));
var _QMARK_msg_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46700__$1,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891));
var vargs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46700__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46700__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var map__46701 = output_opts;
var map__46701__$1 = cljs.core.__destructure_map(map__46701);
var arg__GT_str_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46701__$1,new cljs.core.Keyword(null,"arg->str-fn","arg->str-fn",2064845310),taoensso.timbre.default_arg__GT_str_fn);
var G__46702 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__46702)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__46702)){
return taoensso.timbre.str_join.cljs$core$IFn$_invoke$arity$2(arg__GT_str_fn,vargs);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__46702)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46702)].join('')));
 ...
 */
taoensso.timbre.default_output_error_fn = (function taoensso$timbre$default_output_error_fn(p__46703){
var map__46704 = p__46703;
var map__46704__$1 = cljs.core.__destructure_map(map__46704);
var data = map__46704__$1;
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46704__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var output_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46704__$1,new cljs.core.Keyword(null,"output-opts","output-opts",-793411325));
var err = (((!((_QMARK_err == null))))?_QMARK_err:taoensso.truss.impl._invar_violation_BANG_(true,new cljs.core.Symbol(null,"taoensso.timbre","taoensso.timbre",407940729,null),954,13,"jar:file:/Users/operator/.m2/repository/com/taoensso/timbre/6.6.1/timbre-6.6.1.jar!/taoensso/timbre.cljc",new cljs.core.Keyword("taoensso.truss.impl","some?","taoensso.truss.impl/some?",1536228403),new cljs.core.Symbol("cljs.core","some?","cljs.core/some?",-440439360,null),new cljs.core.Symbol(null,"?err","?err",-2104782470,null),_QMARK_err,null,null));
var nl = "\n";
...
return [nl,nl,"Caused by:",nl,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__46711 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data,new cljs.core.Keyword(null,"?err","?err",549653299),c);
return (taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.default_output_error_fn.cljs$core$IFn$_invoke$arity$1(G__46711) : taoensso.timbre.default_output_error_fn.call(null,G__46711));
})())].join('');
} else {
return null;
}
 ...
 */
taoensso.timbre.default_config = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"min-level","min-level",1634684919),new cljs.core.Keyword(null,"debug","debug",-1608172596),new cljs.core.Keyword(null,"ns-filter","ns-filter",108598448),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["*",null], null), null),new cljs.core.Keyword(null,"middleware","middleware",1462115504),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807),taoensso.timbre.default_timestamp_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn,new cljs.core.Keyword(null,"appenders","appenders",1245583998),(((typeof window !== 'undefined'))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"console","console",1228072057),(function (){var G__46728 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1(G__46728) : taoensso.timbre.console_appender.call(null,G__46728));
})()], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"println","println",1920840330),(function (){var G__46729 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1(G__46729) : taoensso.timbre.println_appender.call(null,G__46729));
})()], null))], null);
...
var args__5775__auto__ = [];
var len__5769__auto___46948 = arguments.length;
var i__5770__auto___46949 = (0);
while(true){
if((i__5770__auto___46949 < len__5769__auto___46948)){
args__5775__auto__.push((arguments[i__5770__auto___46949]));

var G__46950 = (i__5770__auto___46949 + (1));
i__5770__auto___46949 = G__46950;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq46736){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46736));
}));
