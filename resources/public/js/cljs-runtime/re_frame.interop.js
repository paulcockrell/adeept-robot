...
return [(function (){var pred__38036 = cljs.core.instance_QMARK_;
var expr__38037 = reactive_val;
if(cljs.core.truth_((pred__38036.cljs$core$IFn$_invoke$arity$2 ? pred__38036.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__38037) : pred__38036.call(null,reagent.ratom.RAtom,expr__38037)))){
return "ra";
} else {
if(cljs.core.truth_((pred__38036.cljs$core$IFn$_invoke$arity$2 ? pred__38036.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__38037) : pred__38036.call(null,reagent.ratom.RCursor,expr__38037)))){
return "rc";
} else {
if(cljs.core.truth_((pred__38036.cljs$core$IFn$_invoke$arity$2 ? pred__38036.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__38037) : pred__38036.call(null,reagent.ratom.Reaction,expr__38037)))){
return "rx";
} else {
if(cljs.core.truth_((pred__38036.cljs$core$IFn$_invoke$arity$2 ? pred__38036.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__38037) : pred__38036.call(null,reagent.ratom.Track,expr__38037)))){
return "tr";
} else {
return "other";
}
