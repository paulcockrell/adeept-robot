...
var ensure_set_39518 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_39518.cljs$core$IFn$_invoke$arity$1 ? ensure_set_39518.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_39518.call(null,ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_39518.cljs$core$IFn$_invoke$arity$1 ? ensure_set_39518.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_39518.call(null,ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_39518.cljs$core$IFn$_invoke$arity$1 ? ensure_set_39518.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_39518.call(null,ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__39494_SHARP_){
return (!((cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__39494_SHARP_) == null)));
}),ks);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39498_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("clojure.core",p1__39498_SHARP_);
}),names)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39499_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.core",p1__39499_SHARP_);
}),names));
})();
taoensso.truss.impl.safe_pred = (function taoensso$truss$impl$safe_pred(pred){
return (function (x){
try{return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(x) : pred.call(null,x));
}catch (e39500){if((e39500 instanceof Error)){
var _ = e39500;
return null;
} else {
throw e39500;
...
var G__39506 = (new cljs.core.Delay((function (){
...
}catch (e39507){if((e39507 instanceof Error)){
var e = e39507;
...
var output = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"msg_","msg_",-1925147000),msg_,new cljs.core.Keyword(null,"dt","dt",-368444759),instant,new cljs.core.Keyword(null,"pred","pred",1927423397),(function (){var or__5045__auto__ = pred_rsym;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return pred_form;
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__39506) : error_fn.call(null,G__39506));
} else {
return null;
}
});
