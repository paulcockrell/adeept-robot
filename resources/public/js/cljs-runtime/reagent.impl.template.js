...
(reagent.impl.template.UnsafeHTML.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/UnsafeHTML");
}));
...
var G__37890 = o;
reagent.impl.template.goog$module$goog$object.set(G__37890,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37908__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__37908 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__37909__i = 0, G__37909__a = new Array(arguments.length -  0);
while (G__37909__i < G__37909__a.length) {G__37909__a[G__37909__i] = arguments[G__37909__i + 0]; ++G__37909__i;}
  args = new cljs.core.IndexedSeq(G__37909__a,0,null);
} 
return G__37908__delegate.call(this,args);};
G__37908.cljs$lang$maxFixedArity = 0;
G__37908.cljs$lang$applyTo = (function (arglist__37910){
var args = cljs.core.seq(arglist__37910);
return G__37908__delegate(args);
});
...
var G__37891 = o;
reagent.impl.template.goog$module$goog$object.set(G__37891,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37911__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37912__i < G__37912__a.length) {G__37912__a[G__37912__i] = arguments[G__37912__i + 0]; ++G__37912__i;}
  args = new cljs.core.IndexedSeq(G__37912__a,0,null);
} 
return G__37911__delegate.call(this,args);};
G__37911.cljs$lang$maxFixedArity = 0;
G__37911.cljs$lang$applyTo = (function (arglist__37913){
var args = cljs.core.seq(arglist__37913);
return G__37911__delegate(args);
});
...
var G__37892 = props;
var G__37892__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37892,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37892);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37892__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37893 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37893,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37893;
}
})(),id_class);
...
var temp__5804__auto___37914 = (function (){var and__5043__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___37914)){
var d_37915 = temp__5804__auto___37914;
if((d_37915 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_37915.s}));
} else {
...
var G__37894 = (cljs.core.count(argv) - first_child);
switch (G__37894) {
case (0):
...
var vec__37895 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37895,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37895,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37895,(2),null);
...
var temp__5808__auto___37917 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___37917 == null)){
} else {
var key_37918 = temp__5808__auto___37917;
(jsprops.key = key_37918);
}
...
var temp__5808__auto___37919 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___37919 == null)){
} else {
var key_37920 = temp__5808__auto___37919;
(jsprops.key = key_37920);
}
...
var temp__5808__auto___37921 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___37921 == null)){
} else {
var key_37922 = temp__5808__auto___37921;
(jsprops.key = key_37922);
}
...
var temp__5808__auto___37927 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___37927 == null)){
} else {
var key_37928 = temp__5808__auto___37927;
(jsprops.key = key_37928);
}
...
var temp__5808__auto___37929 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___37929 == null)){
} else {
var key_37930 = temp__5808__auto___37929;
(jsprops.key = key_37930);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37898_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37898_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37899 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(1),null);
...
break;
default:
var G__37937 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37938 = compiler;
v = G__37937;
compiler = G__37938;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template37905 = (function (opts,id,fn_to_element,parse_fn,meta37906){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37905.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37907,meta37906__$1){
var self__ = this;
var _37907__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37905(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37906__$1));
}));

(reagent.impl.template.t_reagent$impl$template37905.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37907){
var self__ = this;
var _37907__$1 = this;
return self__.meta37906;
}));

(reagent.impl.template.t_reagent$impl$template37905.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37905.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37905.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37905.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37905.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37905.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37906","meta37906",162099084,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37905.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37905.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37905");

(reagent.impl.template.t_reagent$impl$template37905.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template37905");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37905.
 */
reagent.impl.template.__GT_t_reagent$impl$template37905 = (function reagent$impl$template$__GT_t_reagent$impl$template37905(opts,id,fn_to_element,parse_fn,meta37906){
return (new reagent.impl.template.t_reagent$impl$template37905(opts,id,fn_to_element,parse_fn,meta37906));
});
...
return (new reagent.impl.template.t_reagent$impl$template37905(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
