...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29675 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29675(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29679 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29679(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29683 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29683(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29692 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29692(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29698 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29698(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29704 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29704(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29660,callback){
var map__29661 = p__29660;
var map__29661__$1 = cljs.core.__destructure_map(map__29661);
var input = map__29661__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29661__$1,new cljs.core.Keyword(null,"code","code",1586293142));
